...
1. Read, in order: `AGENTS.md`, `docs/ARCHITECTURE.md`, `docs/TECH_DECISIONS.md`, `docs/PROJECT_MEMORY.md`, `docs/DECISION_LOG.md`, `docs/DEV_LOG.md`, `docs/ask-my-filings-execution-plan.md`.
